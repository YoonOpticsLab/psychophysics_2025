...
% Stimulus
stimulus_duration = 5.750; % In seconds
...
tGuess = 1.0; % TODO: Where is the best place to start the staircase?
tGuessSd = 3.0;

% Define stimulus range (NOT log units)
tMin = (0);  % Minimum allowed intensity
tMax = (2);  % Maximum allowed intensity
